// Grafo.cpp (Diego Henrique, Ícaro Stumpf, Samuel Nascimento; 21 nov. 2019)
...
void Grafo::addEdge(int v1, int v2, int custo)// são três argumentos, mas o primeiro, v1, representa o índice do vetor de listas...
...
int Grafo::dijkstra(int orig, int dest)// calcula a distância entre os dois nodos fornecidos
{
	// vetor de distâncias
	int distancia[V];
